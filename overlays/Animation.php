 ...
 * Animation
 *
 * Animations that can be played on a marker. Use the setAnimation method on a [panix\lib\google\maps\overlays\Marker]
 * or the animation option to play an animation.
 *
 * @author Antonio Ramirez <amigo.cobos@gmail.com>
 * @link http://www.ramirezcobos.com/
 * @link http://www.2amigos.us/
 * @package panix\lib\google\maps\overlays
 */
class Animation
{
